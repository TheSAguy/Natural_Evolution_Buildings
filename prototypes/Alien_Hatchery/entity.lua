...
Natural_Evolution_Biter_Spawner_tint = {
    r = 0.92,
    g = 0.54,
    b = 0,
    a = 0.5
}
Natural_Evolution_Spitter_Spawner_tint = {
    r = 0.54,
    g = 0.92,
    b = 0.3,
    a = 1.0
...
---- Biters
{
    ...
    minable = {
        hardness = 0.2,
        mining_time = 0.5,
        result = "Natural_Evolution_Biter-Spawner-exhausted"
    },
    max_health = 750,
    order = "b-b-i",
    working_sound = {
    ...
    animations = {spawner_idle_animation(0, Natural_Evolution_Biter_Spawner_tint),
    ...
    animation = {spawner_die_animation(0, Natural_Evolution_Biter_Spawner_tint),
...
}, ---- Spitter
{
    ...
    minable = {
        hardness = 0.2,
        mining_time = 0.5,
        result = "Natural_Evolution_Spitter-Spawner-exhausted"
    },
    max_health = 750,
    order = "b-b-j",
    working_sound = {
    ...
    max_count_of_owned_units = 10,
    max_friends_around_to_spawn = 5,
    animations = {spawner_idle_animation(0, Natural_Evolution_Spitter_Spawner_tint),
    ...
    final_render_layer = "corpse",
    animation = {spawner_die_animation(0, Natural_Evolution_Spitter_Spawner_tint),
...
}, ---- Living Wall
{
    ...
    minable = {
        mining_time = 0.5,
        result = "ne-living-wall-exhausted"
    },
