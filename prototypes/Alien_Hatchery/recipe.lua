...
data:extend({ ---- Alien Hatchery
{
    ...
    normal = {
        enabled = false,
        energy_required = 10,
        ingredients = {{"Building_Materials", 5}},
    ...
    expensive = {
        enabled = false,
        energy_required = 20,
        ingredients = {{"Building_Materials", 10}},
        result = "Alien_Hatchery",
        result_count = 1
    }
}, ---- Living Wall
{
    ...
    enabled = false,
    category = "Hatchery",
    ingredients = {{"ne-living-wall-exhausted", 1}, {
        type = "fluid",
...
}, --- Medium Biter Hatching
{
    ...
    normal = {
        enabled = false,
        energy_required = 100,
        ingredients = {{"small-biter-hatching", 1}, {
            type = "fluid",
    ...
    expensive = {
        enabled = false,
        energy_required = 150,
        ingredients = {{"small-biter-hatching", 2}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 40
        }},
...
}, --- Big Biter Hatching
{
    ...
    normal = {
        enabled = false,
        energy_required = 150,
        ingredients = {{"medium-biter-hatching", 1}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 50
        }},
    ...
    expensive = {
        enabled = false,
        energy_required = 250,
        ingredients = {{"medium-biter-hatching", 2}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 75
        }},
...
}, --- Behemoth Biter Hatching
{
    ...
    normal = {
        enabled = false,
        energy_required = 150,
        ingredients = {{"big-biter-hatching", 1}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 100
        }},
    ...
    expensive = {
        enabled = false,
        energy_required = 250,
        ingredients = {{"big-biter-hatching", 2}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 150
        }},
...
}, --- Medium Spitter Hatching
{
    ...
    normal = {
        enabled = false,
        energy_required = 100,
        ingredients = {{"small-spitter-hatching", 1}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 25
        }},
    ...
    expensive = {
        enabled = false,
        energy_required = 125,
        ingredients = {{"small-spitter-hatching", 2}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 35
        }},
...
}, --- Big Spitter Hatching
{
    ...
    normal = {
        enabled = false,
        energy_required = 150,
        ingredients = {{"medium-spitter-hatching", 1}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 50
        }},
    ...
    expensive = {
        enabled = false,
        energy_required = 180,
        ingredients = {{"medium-spitter-hatching", 2}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 75
        }},
...
}, --- Behemoth Spitter Hatching
{
    ...
    normal = {
        enabled = false,
        energy_required = 200,
        ingredients = {{"big-spitter-hatching", 1}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 100
        }},
    ...
    expensive = {
        enabled = false,
        energy_required = 250,
        ingredients = {{"big-spitter-hatching", 2}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 125
        }},
...
}, --- Small Worm Hatching
{
    ...
    category = "Hatchery",
    enabled = false,
    ingredients = {{"small-worm-hatching-exhausted", 1}, {
        type = "fluid",
        name = "NE_revitalization-solution",
        amount = 10
    }},
...
}, --- Medium Worm Hatching
{
    ...
    normal = {
        enabled = false,
        energy_required = 50,
        ingredients = {{"small-worm-hatching", 1}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 50
        }},
    ...
    expensive = {
        enabled = false,
        energy_required = 80,
        ingredients = {{"small-worm-hatching", 2}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 75
        }},
    ...
    category = "Hatchery",
    enabled = false,
    ingredients = {{"medium-worm-hatching-exhausted", 1}, {
        type = "fluid",
        name = "NE_revitalization-solution",
        amount = 20
    }},
...
}, --- Big Worm Hatching
{
    ...
    normal = {
        enabled = false,
        energy_required = 100,
        ingredients = {{"medium-worm-hatching", 1}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 100
        }},
    ...
    expensive = {
        enabled = false,
        energy_required = 150,
        ingredients = {{"medium-worm-hatching", 2}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 150
        }},
    ...
    category = "Hatchery",
    enabled = false,
    ingredients = {{"big-worm-hatching-exhausted", 1}, {
        type = "fluid",
        name = "NE_revitalization-solution",
        amount = 40
    }},
...
}, --- Behemoth Worm Hatching
{
    ...
    normal = {
        enabled = false,
        energy_required = 100,
        ingredients = {{"big-worm-hatching", 1}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 200
        }},
    ...
    expensive = {
        enabled = false,
        energy_required = 150,
        ingredients = {{"big-worm-hatching", 2}, {
            type = "fluid",
            name = "NE_enhanced-nutrient-solution",
            amount = 300
        }},
    ...
    category = "Hatchery",
    enabled = false,
    ingredients = {{"behemoth-worm-hatching-exhausted", 1}, {
        type = "fluid",
        name = "NE_revitalization-solution",
        amount = 80
    }},
...
}, --- Spawner Biter
{
    ...
    category = "Hatchery",
    enabled = false,
    ingredients = {{"Building_Materials", 4}, {"alien-artifact", 50}, {
        type = "fluid",
        name = "NE_enhanced-nutrient-solution",
        amount = 500
    }},
    ...
    category = "Hatchery",
    enabled = false,
    ingredients = {{"Natural_Evolution_Biter-Spawner-exhausted", 1}, {
        type = "fluid",
        name = "NE_revitalization-solution",
        amount = 250
    }},
...
}, --- Spawner Spitter
{
    ...
    category = "Hatchery",
    enabled = false,
    ingredients = {{"Natural_Evolution_Spitter-Spawner-exhausted", 1}, {
        type = "fluid",
        name = "NE_revitalization-solution",
        amount = 250
    }},
...
data:extend({ ---- special liquids for hatchery operation
{
    type = "recipe",
