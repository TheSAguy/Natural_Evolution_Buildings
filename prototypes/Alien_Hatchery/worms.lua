...
small_player_worm.minable = {
    hardness = 0.5,
    mining_time = 1.6,
    result = "small-worm-hatching-exhausted"
}
...
medium_player_worm.minable = {
    hardness = 1,
    mining_time = 1.6,
    result = "medium-worm-hatching-exhausted"
}
...
big_player_worm.minable = {
    hardness = 1.5,
    mining_time = 1.6,
    result = "big-worm-hatching-exhausted"
}
...
behemoth_player_worm.flag =
    {"placeable-neutral", "placeable-player", "not-repairable", "player-creation", "breaths-air"}
behemoth_player_worm.minable = {
    hardness = 2,
    mining_time = 1.6,
    result = "behemoth-worm-hatching-exhausted"
}
