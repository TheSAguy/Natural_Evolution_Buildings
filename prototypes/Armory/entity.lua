        ...
        action = {
            ...
            action_delivery = {
                ...
                target_effects = {{
                    ...
                    damage = {
                        amount = ((Bio_Ammo_Damage + 10) / NE_Difficulty) + NE_Difficulty,
                        type = "Biological"
                    }
        ...
        action = {
            ...
            action_delivery = {
                ...
                target_effects = {{
                    ...
                    damage = {
                        amount = (((Bio_Ammo_Damage + 10) / NE_Difficulty) + NE_Difficulty) / 2,
                        type = "Biological"
                    }
    ...
    --- Dart Turret
{
    ...
    folded_animation = bio_turret_pic {
        direction_count = 8,
        line_length = 1
    },
    preparing_animation = bio_turret_pic {
        direction_count = 8,
        line_length = 1
    },
    prepared_animation = bio_turret_pic {},
    attacking_animation = bio_turret_pic {},
    folding_animation = bio_turret_pic {
        direction_count = 8,
        line_length = 1,
        run_mode = "backward"
    },
