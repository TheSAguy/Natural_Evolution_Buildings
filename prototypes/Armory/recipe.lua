...
--- Standard Dart Ammo
{
    ...
    normal = {
        enabled = false,
        energy_required = 5,
        ingredients = {{"bi-basic-dart-magazine", 10}, {"copper-plate", 5}},
    ...
    expensive = {
        enabled = false,
        energy_required = 8,
        ingredients = {{"bi-basic-dart-magazine", 8}, {"copper-plate", 5}},
        result = "bi-standard-dart-magazine",
        result_count = 8
    }
}, 
...
--- Enhanced Dart Ammo
{
    ...
    normal = {
        enabled = false,
        energy_required = 6,
        ingredients = {{"bi-standard-dart-magazine", 10}, {"plastic-bar", 5}},
    ...
    expensive = {
        enabled = false,
        energy_required = 9,
        ingredients = {{"bi-standard-dart-magazine", 8}, {"plastic-bar", 5}},
        result = "bi-enhanced-dart-magazine",
        result_count = 8
    }
}, 
...
--- Poison Dart Ammo
{
    ...
    normal = {
        enabled = false,
        energy_required = 8,
        ingredients = {{"bi-enhanced-dart-magazine", 10}, {"poison-capsule", 5}},
    ...
    expensive = {
        enabled = false,
        energy_required = 12,
        ingredients = {{"bi-enhanced-dart-magazine", 8}, {"poison-capsule", 5}},
        result = "bi-poison-dart-magazine",
        result_count = 8
    }
}, 
...
--- piercing-rounds-magazine from Copper Ammo
{
    ...
    normal = {
        enabled = false,
        energy_required = 3,
        ingredients = {{"copper-bullet-magazine", 1}, {"steel-plate", 1}, {"copper-plate", 8}},
    ...
    expensive = {
        enabled = false,
        energy_required = 5,
        ingredients = {{"copper-bullet-magazine", 1}, {"steel-plate", 1}, {"copper-plate", 10}},
        result = "piercing-rounds-magazine",
        result_count = 1
    }
}, 
...
--- Bio Ammo
{
    ...
    normal = {
        enabled = false,
        energy_required = 5,
        ingredients = {{"piercing-rounds-magazine", 10}, {
            type = "fluid",
            name = "NE_alien_toxin",
            amount = 10
        }},
    ...
    expensive = {
        enabled = false,
        energy_required = 8,
        ingredients = {{"piercing-rounds-magazine", 12}, {
            type = "fluid",
            name = "NE_alien_toxin",
            amount = 15
        }},
...
--- Conversion Basic Dart
{
    ...
    normal = {
        enabled = false,
        energy_required = 2,
        ingredients = {{"Alien-Stimulant", 1}, {"bi-basic-dart-magazine", 1}},
    ...
    expensive = {
        enabled = false,
        energy_required = 4,
        ingredients = {{"Alien-Stimulant", 2}, {"bi-basic-dart-magazine", 1}},
        result = "bi-basic-dart-magazine_c",
        result_count = 1
    }
}, 
...
--- Standard Dart
{
    ...
    normal = {
        enabled = false,
        energy_required = 2,
        ingredients = {{"Alien-Stimulant", 1}, {"bi-standard-dart-magazine", 1}},
    ...
    expensive = {
        enabled = false,
        energy_required = 4,
        ingredients = {{"Alien-Stimulant", 2}, {"bi-standard-dart-magazine", 1}},
        result = "bi-standard-dart-magazine_c",
        result_count = 1
    }
}, 
...
--- Enhanced Dart
{
    ...
    normal = {
        enabled = false,
        energy_required = 2,
        ingredients = {{"Alien-Stimulant", 1}, {"bi-enhanced-dart-magazine", 1}},
    ...
    expensive = {
        enabled = false,
        energy_required = 4,
        ingredients = {{"Alien-Stimulant", 2}, {"bi-enhanced-dart-magazine", 1}},
        result = "bi-enhanced-dart-magazine_c",
        result_count = 1
    }
}, 
...
--- Poison Dart
{
    ...
    normal = {
        enabled = false,
        energy_required = 2,
        ingredients = {{"Alien-Stimulant", 1}, {"bi-poison-dart-magazine", 1}},
    ...
    expensive = {
        enabled = false,
        energy_required = 4,
        ingredients = {{"Alien-Stimulant", 2}, {"bi-poison-dart-magazine", 1}},
        result = "bi-poison-dart-magazine_c",
        result_count = 1
    }
}, 
...
--- Conversion Ammo Copper
{
    ...
    normal = {
        enabled = false,
        energy_required = 3,
        ingredients = {{"Alien-Stimulant", 1}, {"copper-bullet-magazine", 1}},
    ...
    expensive = {
        enabled = false,
        energy_required = 5,
        ingredients = {{"Alien-Stimulant", 2}, {"copper-bullet-magazine", 1}},
        result = "copper-bullet-magazine_c",
        result_count = 1
    }
}, 
...
---- Conversion firearm-magazine
{
    ...
    normal = {
        enabled = false,
        energy_required = 3,
        ingredients = {{"Alien-Stimulant", 1}, {"firearm-magazine", 1}},
    ...
    expensive = {
        enabled = false,
        energy_required = 5,
        ingredients = {{"Alien-Stimulant", 2}, {"firearm-magazine", 1}},
        result = "firearm-magazine_c",
        result_count = 1
    }
...
---- Conversion piercing-rounds-magazine
{
    ...
    normal = {
        enabled = false,
        energy_required = 3,
        ingredients = {{"Alien-Stimulant", 1}, {"piercing-rounds-magazine", 1}},
    ...
    expensive = {
        enabled = false,
        energy_required = 5,
        ingredients = {{"Alien-Stimulant", 2}, {"piercing-rounds-magazine", 1}},
        result = "piercing-rounds-magazine_c",
        result_count = 1
    }
...
---- Conversion uranium-rounds-magazine
{
    ...
    normal = {
        enabled = false,
        energy_required = 4,
        ingredients = {{"Alien-Stimulant", 1}, {"uranium-rounds-magazine", 1}},
    ...
    expensive = {
        enabled = false,
        energy_required = 6,
        ingredients = {{"Alien-Stimulant", 2}, {"uranium-rounds-magazine", 1}},
        result = "uranium-rounds-magazine_c",
        result_count = 1
    }
...
--- Conversion Biological-bullet-magazine
{
    ...
    normal = {
        enabled = false,
        energy_required = 4,
        ingredients = {{"Alien-Stimulant", 1}, {"Biological-bullet-magazine", 1}},
...
--- Long Range Turret
{
    ...
    normal = {
        enabled = false,
        energy_required = 8,
        ingredients = {{"electronic-circuit", 10}, {"gun-turret", 1}, {"steel-plate", 10}},
    ...
    expensive = {
        enabled = false,
        energy_required = 16,
        ingredients = {{"electronic-circuit", 10}, {"gun-turret", 2}, {"steel-plate", 10}},
        result = "NE-gun-turret",
        result_count = 1
    }
...
--- Rocket Turret
{
    ...
    normal = {
        enabled = false,
        energy_required = 8,
        ingredients = {{"electronic-circuit", 10}, {"NE-gun-turret", 1}, {"steel-plate", 10}},
    ...
    expensive = {
        enabled = false,
        energy_required = 16,
        ingredients = {{"electronic-circuit", 10}, {"NE-gun-turret", 2}, {"steel-plate", 10}},
        result = "NE-rocket-turret",
        result_count = 1
    }
...
--- Dart Rifle
{
    ...
    normal = {
        enabled = true,
        energy_required = 8,
        ingredients = {{"copper-plate", 5}, {"wood", 15}},
    ...
    expensive = {
        enabled = true,
        energy_required = 16,
        ingredients = {{"copper-plate", 10}, {"wood", 25}},
        result = "bi-dart-rifle",
        result_count = 1
    }
