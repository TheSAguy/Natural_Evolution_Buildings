if remote.interfaces.EvoGUI then
    ...
    function EvoGUI.create_Evo_Deduction_Text()
        ...
        local fractional_component = math.floor((global.Total_TerraformingStations_Evo_Deduction * 100 - whole_number) *
                                                    100)
    ...
    function EvoGUI.update_gui()
        ...
        remote.call("EvoGUI", "update_remote_sensor", "evolution_destruction", EvoGUI.create_Evo_Destruction_Text(),
            color)
